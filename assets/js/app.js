...
function renderToolWall(filter=''){
 ...
 const suites=`<a class="tool-card active-card cotton-suite-card" href="cotton/"><span class="badge cotton-suite-badge">Industry Suite</span><h3>Cotton Trade Operating System</h3><p>A connected toolkit for ginners, cotton buyers, sellers and cross-border trade.</p></a><a class="tool-card active-card" href="lead-zinc/"><span class="badge badge-active">Industry Suite</span><h3>Lead / Zinc Ore Trade Suite</h3><p>Buyer-focused tools for zinc-first ore and concentrate valuation, settlement, assays and logistics.</p></a>`;
